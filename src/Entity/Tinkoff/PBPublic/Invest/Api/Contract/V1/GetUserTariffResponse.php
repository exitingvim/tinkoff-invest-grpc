...
namespace Tinkoff\PBPublic\Invest\Api\Contract\V1;
...
class GetUserTariffResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Tinkoff\PBPublic\Invest\Api\Contract\V1\UnaryLimit[]|\Google\Protobuf\Internal\RepeatedField $unary_limits
     *          Массив лимитов пользователя по unary-запросам
     *     @type \Tinkoff\PBPublic\Invest\Api\Contract\V1\StreamLimit[]|\Google\Protobuf\Internal\RepeatedField $stream_limits
     *          Массив лимитов пользователей для stream-соединений
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .tinkoff.public.invest.api.contract.v1.UnaryLimit unary_limits = 1;</code>
     * @param \Tinkoff\PBPublic\Invest\Api\Contract\V1\UnaryLimit[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setUnaryLimits($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Tinkoff\PBPublic\Invest\Api\Contract\V1\UnaryLimit::class);
     ...
     *
     * Generated from protobuf field <code>repeated .tinkoff.public.invest.api.contract.v1.StreamLimit stream_limits = 2;</code>
     * @param \Tinkoff\PBPublic\Invest\Api\Contract\V1\StreamLimit[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setStreamLimits($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Tinkoff\PBPublic\Invest\Api\Contract\V1\StreamLimit::class);
