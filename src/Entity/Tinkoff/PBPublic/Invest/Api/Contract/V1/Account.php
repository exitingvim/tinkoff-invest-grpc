...
class Account extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Tinkoff\PBPublic\Invest\Api\Contract\V1\AccountType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Tinkoff\PBPublic\Invest\Api\Contract\V1\AccountStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Tinkoff\PBPublic\Invest\Api\Contract\V1\AccessLevel::class);
